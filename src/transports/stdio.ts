 ...
 * Wires the stdio transport using serveStdio and initializes tools and resources according to profile, workspace config, network policy, and network cache policy.
 */
